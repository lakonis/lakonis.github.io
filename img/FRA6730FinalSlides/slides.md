...
* δύναμις
* potentialité d'une production du réel
* valorisation par rapport au réel _en puissance_
...
* mouvement, incarnation de l'imaginaire
* virtuel
...
===
De même, dans la lignée du séminaire, on peut rapprocher le modèle du mouvement, de l'imaginaire incarné tels que Paul Valéry les pense. Le modèle, comme la fonction et la forme géométrique de l'architecte, est de l'ordre du virtuel, de l'écriture du mouvement. Il est source de possibles.
...
* quelles unités ?
  * atomicité du texte : le mot, la ligne, le chapitre, l'auteur, etc.
* quelles tâches ?
  * fonctions sur le  texte : copier, imprimer, indexer, compter, etc.
...
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
### Modèle et subjectivité

* dialogue monde-chercheur
* interprétation
...
Dans ce dialogue monde-chercheur, on peut apercevoir le dialogue croisé entre modèle et machine, la machine opérant, performant le modèle, porteurs ensemble du couple requête-résultat. Résultats qui restent encore à interpréter, autant que le modèle comme nous y invite JeanG Meunier.

§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§

### Les _oracles_ de Turing
